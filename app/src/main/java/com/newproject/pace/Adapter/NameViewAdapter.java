...
public class NameViewAdapter extends RecyclerView.Adapter<NameViewAdapter.ViewHolder> {

    private List<getContactName> listdata;
    private Context mContext;
    private ArrayList<Integer> arraylist = new ArrayList<>(); // use a dynamic array.


    public NameViewAdapter(List<getContactName> listdata, Context mContext) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        getContactName contactVO = listdata.get(position);
        holder.tvContactName.setText(contactVO.getFullName());
